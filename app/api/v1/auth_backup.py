...
async def register(
    ...
    try:
        ...
        # Send OTP
        otp = await OTPService.create_otp(db, user.email, purpose="registration")
...
async def resend_otp(
    ...
    try:
        ...
        # Create new OTP
        otp = await OTPService.create_otp(db, otp_request.email, purpose="registration")
        ...
        return {
            ...
            "expires_in_minutes": otp.expires_at
        }
    except HTTPException:
        raise
    except Exception as e:
...
async def login(
    ...
    otp = await OTPService.create_otp(db, user.email, purpose="login")
